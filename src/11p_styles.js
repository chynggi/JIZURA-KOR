/* JIZURA pack: styles — sixteen more style packs (색 배합 세트: colour schemes, font roles, texture, tendencies) */
(() => {
'use strict';
...
const S = {
  ...
  /* ---------------------------------------------------------------- 레트로 미디어 */
  retro: {
    name: '레트로 미디어', desc: '바랜 크림과 탁한 남색·VHS 번짐·브라운관·카세트 라벨', moods: ['emotional', 'glitch', 'editorial'],
    schemes: [
      { bg: '#1E2438', fg: '#F2E6CF', sub: '#A9A38F', accent: '#E8553C', accent2: '#48C6C9', ink: '#F2E6CF', dim: '#283048', ghostA: '#E8553C', ghostB: '#48C6C9' },
      { bg: '#EDE3CC', fg: '#1E2438', sub: '#5B5A58', accent: '#C9412C', accent2: '#1F7F86', ink: '#1E2438', dim: '#E0D5BB', ghostA: '#E8553C', ghostB: '#2FA3A8', paper: true },
      { bg: '#0D0F14', fg: '#E9F0E4', sub: '#8A9A88', accent: '#F2B53C', accent2: '#E8553C', ink: '#F2B53C', dim: '#171B22', ghostA: '#FF3B3B', ghostB: '#3BD6FF' },
    ],
    fonts: { display: ['kr_black', 'dot', 'kr_display'], serif: ['kr_serif_bold'], body: ['kr_med'], mono: ['dot', 'mono'] },
    texture: { grain: 1, paper: 0.2, scan: 0.7 }, ghost: 1.1,
    bias: {
      layout: { cassette: 2, vinyl: 1.6, ticker: 1.5, subtitleBar: 1.5, filmstrip: 1.4, dotMatrix: 1.2, ledScroll: 1, center: 1 },
      enter: { crtOn: 2, interlace: 1.6, type: 1.4, flicker: 1.2, filmFeed: 1.2 },
      exit: { scanOut: 1.6, glitch: 1.2, blur: 1 },
      treat: { glitchSplit: 1.3, softShadow: 1 },
      bg: { vhsBand: 1.8, tvBars: 1.3, scanBars: 1.3, filmStrip: 1.2, noiseField: 1 },
      cam: { handheld: 1.3, floatNoise: 1.2 },
      fx: { vhsRoll: 2, trackingNoise: 1.8, crtOff: 1.4, filmBurn: 1.3, dustScratches: 1.3, tvStatic: 1 },
    },
    decor: { timecodeBar: 1.6, mediaControls: 1.4, dateStamp: 1.2, volumeBars: 1, progressBar: 0.8 }, hud: true,
  },

  /* ---------------------------------------------------------------- 만화 */
  manga: {
    name: '만화·스크린톤', desc: '흰 종이·먹색 선·스크린톤 회색·말풍선과 집중선', moods: ['pop', 'graphic'],
    schemes: [
      { bg: '#F7F5F0', fg: '#141414', sub: '#6E6E6E', accent: '#141414', accent2: '#E23A3A', ink: '#141414', dim: '#E4E2DC', ghostA: '#9A9A9A', ghostB: '#E23A3A', paper: true },
      { bg: '#141414', fg: '#F7F5F0', sub: '#A6A6A6', accent: '#FFE14A', accent2: '#F7F5F0', ink: '#F7F5F0', dim: '#222222', ghostA: '#FFE14A', ghostB: '#8A8A8A' },
      { bg: '#FFE14A', fg: '#141414', sub: '#4A4020', accent: '#E23A3A', accent2: '#141414', ink: '#141414', dim: '#F2D23C', ghostA: '#E23A3A', ghostB: '#141414' },
    ],
    fonts: { display: ['kr_display', 'kr_black', 'pop'], serif: ['kr_serif_bold'], body: ['kr_bold'], mono: ['mono'] },
    texture: { grain: 0.35, paper: 0.6, scan: 0 }, ghost: 0.45,
    bias: {
      layout: { bubble: 2, crowdBubbles: 1.8, burst: 1.7, panels: 1.6, huge: 1.3, diag: 1.2, mixed: 1.1 },
      enter: { pop: 1.8, stamp: 1.6, squashDrop: 1.4, zoom: 1.2, slideWhole: 1.1 },
      exit: { popOut: 1.5, scatter: 1.3, shrink: 1.2 },
      treat: { outline: 1.8, hardShadow: 1.6, halftone: 1.4, toneShadow: 1.4, extrude: 1.1 },
      bg: { speedLines: 2, halftoneFade: 1.6, sunburst: 1.4, concentric: 1.1 },
      cam: { crashZoom: 1.5, beatPunch: 1.3, snapPan: 1.2 },
      fx: { focusLines: 2, speedLines: 1.8, halftone: 1.5, zoomPunch: 1.2, whiteFrame: 1 },
    },
    decor: { starburst: 1.6, halftonePatch: 1.5, lineBurst: 1.4, speedCorner: 1.2, heartsStars: 0.8 }, hud: false,
  },

  /* ---------------------------------------------------------------- 네온 */
  neonCity: {
    name: '네온·시티', desc: '짙은 남보라 밤·핑크와 시안 발광·간판 점멸·비 오는 창', moods: ['emotional', 'pop', 'glitch'],
    schemes: [
      { bg: '#0B0820', fg: '#FF4FD8', sub: '#9A86D8', accent: '#3CF2FF', accent2: '#FFE66D', ink: '#3CF2FF', dim: '#16102E', ghostA: '#FF4FD8', ghostB: '#3CF2FF' },
      { bg: '#060B1C', fg: '#3CF2FF', sub: '#7FA3C8', accent: '#FF4FD8', accent2: '#B6FF5C', ink: '#FF4FD8', dim: '#0E1630', ghostA: '#3CF2FF', ghostB: '#FF4FD8' },
      { bg: '#1A0B24', fg: '#FFF3FB', sub: '#C79ADB', accent: '#FF4FD8', accent2: '#3CF2FF', ink: '#FF4FD8', dim: '#261133', ghostA: '#FF4FD8', ghostB: '#3CF2FF', grad: ['#FF4FD8', '#3CF2FF'] },
    ],
    fonts: { display: ['kr_display', 'kr_black', 'rampart'], serif: ['kr_serif_bold'], body: ['kr_med'], mono: ['mono'] },
    texture: { grain: 0.45, paper: 0, scan: 0.25 }, ghost: 0.9,
    bias: {
      layout: { neon: 2.2, ledScroll: 1.6, billboard: 1.5, parallax: 1.3, center: 1.2, circle: 1 },
      enter: { neonOn: 2.2, flicker: 1.8, backlight: 1.3, blur: 1.1 },
      exit: { lampOff: 1.8, blur: 1.2, glitch: 1 },
      treat: { neonOutline: 2.2, glow: 1.8, outline: 1.1 },
      bg: { skyline: 1.8, rainWindow: 1.7, bokehBg: 1.4, retroGrid: 1.1 },
      cam: { dollyIn: 1.3, driftDiag: 1.2, yawTurn: 1.2 },
      fx: { bloomFlash: 1.6, strobe: 1.2, rgbSplit: 1.1, lightSweep: 1.1 },
    },
    decor: { bokeh: 1.4, twinkle: 1.2, sparks: 1, fireflies: 0.8 }, hud: false, glow: 1.9,
  },

  /* ---------------------------------------------------------------- 스위스 */
  swiss: {
    name: '미니멀·스위스', desc: '흰 바탕·검정·빨강 한 색·그리드와 큰 여백', moods: ['editorial', 'graphic', 'calm'],
    schemes: [
      { bg: '#F4F2EE', fg: '#111111', sub: '#6A6A6A', accent: '#E3261C', accent2: '#111111', ink: '#111111', dim: '#E6E3DD', ghostA: '#E3261C', ghostB: '#9A9A9A' },
      { bg: '#E3261C', fg: '#FFFFFF', sub: '#FFEDEB', accent: '#111111', accent2: '#FFFFFF', ink: '#111111', dim: '#CF2118', ghostA: '#111111', ghostB: '#FFFFFF' },
      { bg: '#111111', fg: '#F4F2EE', sub: '#8E8E8E', accent: '#E3261C', accent2: '#F4F2EE', ink: '#F4F2EE', dim: '#1C1C1C', ghostA: '#E3261C', ghostB: '#6A6A6A' },
    ],
    fonts: { display: ['kr_black', 'kr_bold'], serif: ['kr_serif_bold'], body: ['kr_med', 'kr_ui'], mono: ['mono'] },
    texture: { grain: 0.15, paper: 0, scan: 0 }, ghost: 0.25,
    bias: {
      layout: { swissGrid: 2.4, poster: 1.8, columnsBig: 1.6, justified: 1.5, numbered: 1.3, headlineDeck: 1.2, center: 0.8, stickerBomb: 0.1, bubbles: 0.1, balloons: 0.1 },
      enter: { wipe: 1.8, slideL: 1.6, riseMask: 1.5, cut: 1.3, trackIn: 1.1, bounceBig: 0.2, rubber: 0.2 },
      exit: { wipe: 1.6, slideOutL: 1.4, sinkMask: 1.3, cut: 1.2, explode: 0.2 },
      treat: { underline: 1.3, boxed: 1.1, rainbow: 0.1, chrome: 0.1 },
      bg: { splitV: 1.6, splitH: 1.4, bigStripes: 1.1, borderFrame: 1.1, polka: 0.2, fireworks: 0.1 },
      cam: { panL: 1.2, panR: 1.2, earthquake: 0.1, shakeHard: 0.1 },
      fx: { panelWipe: 1.4, blindsTrans: 1.2, pixelSort: 0.2, tvStatic: 0.1 },
    },
    decor: { rulerEdge: 1.6, guides: 1.4, indexNum: 1.3, cropMarks: 1, confetti: 0.1, petals: 0.1 }, hud: false,
  },
};
