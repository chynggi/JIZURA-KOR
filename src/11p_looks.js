...
/* ================= TREATMENTS ================= */
reg('treat', 'outline', { name: '속 빈 글자', tags: ['graphic', 'pop', 'glitch', 'emotional'], w: 1.2,
...
reg('treat', 'outlineFill', { name: '외곽선', tags: ['pop', 'graphic'], w: 1,
...
reg('treat', 'doubleOutline', { name: '이중 외곽선', tags: ['pop', 'graphic'], w: 0.7,
...
reg('treat', 'extrude', { name: '입체', tags: ['pop', 'graphic'], w: 0.9,
...
reg('treat', 'longShadow', { name: '긴 그림자', tags: ['pop', 'graphic'], w: 0.6,
...
reg('treat', 'hardShadow', { name: '옮긴 그림자', tags: ['pop', 'graphic', 'glitch'], w: 1,
...
reg('treat', 'softShadow', { name: '흐린 그림자', tags: ['calm', 'emotional', 'editorial'], w: 0.8, safe: true,
...
reg('treat', 'glow', { name: '발광', tags: ['emotional', 'calm', 'glitch'], w: 0.9, safe: true,
...
reg('treat', 'marker', { name: '마커', tags: ['pop', 'graphic', 'editorial'], w: 1,
...
reg('treat', 'underline', { name: '밑줄', tags: ['editorial', 'calm', 'graphic'], w: 0.8,
...
reg('treat', 'strike', { name: '취소선', tags: ['glitch', 'editorial', 'emotional'], w: 0.5,
...
reg('treat', 'boxed', { name: '상자 조판', tags: ['graphic', 'editorial', 'pop'], w: 0.7,
...
reg('treat', 'gradientV', { name: '세로 그라데이션', tags: ['emotional', 'pop'], w: 0.9,
...
reg('treat', 'splitColor', { name: '상하 2색', tags: ['pop', 'graphic'], w: 0.8,
...
reg('treat', 'halftone', { name: '망점', tags: ['pop', 'graphic'], w: 0.7, plan: rng => ({ v: rng.pick(['tone', 'tone', 'duo']) }), apply: patternTreat('dots') });
reg('treat', 'stripes', { name: '줄무늬', tags: ['pop', 'graphic'], w: 0.6, plan: rng => ({ v: rng.pick(['tone', 'duo', 'lines']) }), apply: patternTreat('stripes', 'lines') });
reg('treat', 'hatch', { name: '사선', tags: ['graphic', 'editorial', 'glitch'], w: 0.5, plan: rng => ({ v: rng.pick(['tone', 'tone', 'duo']) }), apply: patternTreat('hatch') });

reg('treat', 'dotted', { name: '점선 외곽선', tags: ['calm', 'editorial', 'graphic'], w: 0.5,
...
reg('treat', 'alternate', { name: '교차 색상', tags: ['pop', 'graphic'], w: 0.8,
...
reg('treat', 'italic', { name: '기울임체', tags: ['editorial', 'pop', 'emotional'], w: 0.8, safe: true,
...
reg('treat', 'wide', { name: '넓은 글자', tags: ['graphic', 'pop'], w: 0.7, safe: true,
  apply(env, it) {
    if (!it.text) return;
...
reg('treat', 'tall', { name: '길쭉한 글자', tags: ['editorial', 'calm', 'graphic', 'emotional'], w: 0.7, safe: true,
  apply(env, it) {
    if (!it.text) return;
    it.sx = (it.sx || 1) * 0.8;
...
reg('treat', 'echoOutline', { name: '외곽선 잔향', tags: ['glitch', 'emotional', 'graphic'], w: 0.7,
...
reg('treat', 'emphasisDots', { name: '강조점', tags: ['editorial', 'emotional', 'calm'], w: 0.8,
...
bgReg('sunburst', { name: '방사', tags: ['pop', 'graphic'], w: 0.8,
...
bgReg('concentric', { name: '동심원', tags: ['calm', 'graphic', 'emotional'], w: 0.9,
...
bgReg('halftoneFade', { name: '망점 그라데이션', tags: ['pop', 'graphic', 'editorial'], w: 1,
...
bgReg('bigStripes', { name: '큰 사선', tags: ['graphic', 'pop'], w: 0.9,
...
bgReg('splitV', { name: '좌우 2색', tags: ['graphic', 'editorial', 'pop'], w: 1,
...
bgReg('splitH', { name: '상하 2색', tags: ['graphic', 'editorial', 'calm'], w: 0.9,
...
bgReg('splitDiag', { name: '사선 2색', tags: ['graphic', 'pop'], w: 1,
...
bgReg('gradientSweep', { name: '그라데이션', tags: ['calm', 'emotional', 'pop'], w: 1, subtle: true,
...
bgReg('spotlight', { name: '스포트라이트', tags: ['emotional', 'calm', 'editorial'], w: 0.9, subtle: true,
...
bgReg('tvBars', { name: 'TV 띠', tags: ['glitch', 'graphic', 'emotional'], w: 0.6,
...
bgReg('checker', { name: '체크무늬', tags: ['graphic', 'pop'], w: 0.7,
...
bgReg('bigChar', { name: '거대 글자', tags: ['editorial', 'emotional', 'graphic', 'calm'], w: 1, subtle: true,
...
bgReg('speedLines', { name: '속선', tags: ['pop', 'emotional', 'graphic'], w: 0.7,
...
bgReg('scanBars', { name: '스캔선 띠', tags: ['calm', 'glitch', 'editorial'], w: 0.9, subtle: true,
...
bgReg('dotGrid', { name: '도트 격자', tags: ['calm', 'editorial', 'graphic'], w: 1, subtle: true,
...
bgReg('retroGrid', { name: '레트로 격자', tags: ['pop', 'glitch', 'graphic'], w: 0.6,
...
bgReg('bokehBg', { name: '보케 빛', tags: ['emotional', 'calm', 'pop'], w: 1,
...
bgReg('particlesBg', { name: '떠오르는 입자', tags: ['emotional', 'calm', 'pop'], w: 1,
...
bgReg('ripples', { name: '잔물결', tags: ['calm', 'emotional', 'graphic'], w: 0.9,
...
bgReg('polka', { name: '물방울 무늬', tags: ['pop', 'graphic'], w: 0.7,
...
bgReg('eqBars', { name: '이퀄라이저', tags: ['pop', 'glitch', 'graphic'], w: 0.6,
...
bgReg('borderFrame', { name: '굵은 테두리', tags: ['graphic', 'pop', 'editorial'], w: 0.7,
...
bgReg('letterbox', { name: '시네스코 띠', tags: ['emotional', 'editorial', 'calm'], w: 0.6,
...
bgReg('noiseField', { name: '노이즈 흔들림', tags: ['glitch', 'emotional'], w: 0.6,
...
reg('cam', 'pullOut', { name: '줌 아웃', tags: ['calm', 'emotional', 'editorial'], w: 1,
  plan: rng => ({ a: rng.range(0.06, 0.09) }),
  get: (env, P) => ({ s: 1 + (P.a || 0.07) * KM(env) * (1 - E.outCubic(cuOf(env))) }) });

reg('cam', 'panL', { name: '왼쪽 팬', tags: ['calm', 'editorial', 'emotional', 'graphic'], w: 0.9,
  plan: rng => ({ a: rng.range(0.018, 0.028) }),
  get: (env, P) => ({ x: (panP(cuOf(env)) - 0.5) * 2 * env.W * (P.a || 0.022) * KM(env), s: 1.02 }) });

reg('cam', 'panR', { name: '오른쪽 팬', tags: ['calm', 'editorial', 'emotional', 'graphic'], w: 0.9,
  plan: rng => ({ a: rng.range(0.018, 0.028) }),
  get: (env, P) => ({ x: -(panP(cuOf(env)) - 0.5) * 2 * env.W * (P.a || 0.022) * KM(env), s: 1.02 }) });

reg('cam', 'tiltUp', { name: '틸트', tags: ['calm', 'emotional', 'editorial'], w: 0.8,
  plan: rng => ({ a: rng.range(0.02, 0.03) }),
  get: (env, P) => ({ y: (panP(cuOf(env)) - 0.5) * 2 * env.H * (P.a || 0.025) * KM(env), s: 1.02 }) });

reg('cam', 'dutch', { name: '더치', tags: ['emotional', 'glitch', 'graphic'], w: 0.8,
...
reg('cam', 'handheld', { name: '핸드헬드', tags: ['emotional', 'calm', 'editorial'], w: 1,
...
reg('cam', 'beatPunch', { name: '박자 줌', tags: ['pop', 'glitch', 'graphic'], w: 0.9,
...
reg('cam', 'whipIn', { name: '휩 인', tags: ['pop', 'glitch', 'graphic'], w: 0.7, strong: true,
...
reg('cam', 'crashZoom', { name: '크래시 줌', tags: ['pop', 'glitch', 'emotional'], w: 0.6, strong: true,
...
reg('cam', 'bounce', { name: '바운스', tags: ['pop', 'graphic'], w: 0.9,
...
reg('cam', 'roll', { name: '롤 회전', tags: ['emotional', 'calm', 'glitch'], w: 0.8,
  plan: rng => ({ dir: rng.pick([1, -1]), a: rng.range(2.5, 4) }),
  get: (env, P) => ({ rot: (P.dir || 1) * (cuOf(env) - 0.5) * (P.a || 3) * KM(env), s: 1.025 }) });

reg('cam', 'driftDiag', { name: '사선 드리프트', tags: ['calm', 'emotional', 'editorial', 'graphic'], w: 1,
...
reg('cam', 'shakeHard', { name: '강한 흔들림', tags: ['glitch', 'pop', 'emotional'], w: 0.6, strong: true,
  get: (env) => {
...
reg('cam', 'dollyIn', { name: '돌리 인', tags: ['emotional', 'calm', 'editorial'], w: 1,
...
reg('cam', 'stepZoom', { name: '단계 줌', tags: ['pop', 'graphic', 'glitch'], w: 0.8,
...
fxReg('panelWipe', { name: '패널 와이프', tags: ['pop', 'graphic'], w: 1, dur: 5, pre: 2, amp: 1,
  draw(ctx, ev, k, I) {
...
fxReg('irisTrans', { name: '아이리스', tags: ['pop', 'editorial'], w: 0.7, dur: 8, pre: 4, amp: 1,
  draw(ctx, ev, k, I) {
...
fxReg('doors', { name: '문 전환', tags: ['graphic', 'pop'], w: 0.7, dur: 8, pre: 4, amp: 1,
  draw(ctx, ev, k, I) {
...
fxReg('blindsTrans', { name: '블라인드', tags: ['graphic', 'editorial'], w: 0.7, dur: 6, pre: 3, amp: 1,
  draw(ctx, ev, k, I) {
...
fxReg('rgbSplit', { name: 'RGB 분리', tags: ['glitch', 'emotional'], w: 1, dur: 4, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
...
fxReg('smear', { name: '가로 스미어', tags: ['glitch'], w: 0.8, dur: 3, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
...
fxReg('vhsRoll', { name: 'VHS 롤', tags: ['glitch', 'emotional'], w: 0.8, dur: 6, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
...
fxReg('trackingNoise', { name: '트래킹 노이즈', tags: ['glitch', 'emotional'], w: 0.8, dur: 4, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S, sc } = I; if (!S) return;
...
fxReg('mirrorFlash', { name: '미러 플래시', tags: ['glitch', 'graphic'], w: 0.6, dur: 2, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
...
fxReg('strobe', { name: '스트로보', tags: ['glitch', 'pop'], w: 0.5, dur: 4, amp: 1, mid: true,
  draw(ctx, ev, k, I) {
    if (Math.floor(k * 4) % 2) return;
    ctx.globalCompositeOperation = 'difference'; ctx.fillStyle = '#ffffff'; ctx.fillRect(0, 0, I.cw, I.ch);
  } });

fxReg('posterize', { name: '포스터라이즈', tags: ['glitch', 'pop', 'graphic'], w: 0.7, dur: 3, amp: 1, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
...
fxReg('tileShift', { name: '타일 밀기', tags: ['glitch', 'graphic'], w: 0.8, dur: 3, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S, sc } = I; if (!S) return;
...
fxReg('filmBurn', { name: '필름 타버림', tags: ['emotional', 'calm', 'editorial'], w: 0.7, dur: 7, pre: 2, amp: 1, mid: true,
  draw(ctx, ev, k, I) {
...
fxReg('whipBlur', { name: '휩 블러', tags: ['pop', 'graphic', 'emotional'], w: 1, dur: 5, pre: 2, amp: 1, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S, sc } = I; if (!S) return;
...
fxReg('blackFrame', Object.assign(koma('#000000'), { name: '검은 컷', w: 0.6 }));
fxReg('whiteFrame', Object.assign(koma('#ffffff'), { name: '하얀 컷', w: 0.5 }));

fxReg('gridRepeat', { name: '화면 분할', tags: ['pop', 'graphic', 'glitch'], w: 0.7, dur: 3, amp: 1, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S, sc } = I; if (!S) return;
...
fxReg('waveWarp', { name: '물결 왜곡', tags: ['emotional', 'glitch'], w: 0.7, dur: 5, amp: 1, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
...
fxReg('pixelDrift', { name: '픽셀 밀기', tags: ['glitch'], w: 0.8, dur: 3, amp: 1, glitchy: true, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
...
fxReg('zoomPunch', { name: '줌 펀치', tags: ['pop', 'graphic', 'glitch'], w: 1, dur: 4, amp: 1, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
...
fxReg('lightSweep', { name: '빛 줄기', tags: ['pop', 'emotional', 'calm'], w: 0.9, dur: 7, amp: 1, mid: true,
  draw(ctx, ev, k, I) {
...
fxReg('crtOff', { name: '브라운관 꺼짐', tags: ['glitch', 'emotional'], w: 0.3, dur: 8, pre: 4, amp: 1, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S } = I; if (!S) return;
    let sy, sx, br;
...
fxReg('splitSlide', { name: '상하 슬라이드', tags: ['graphic', 'pop', 'glitch'], w: 0.9, dur: 6, pre: 2, amp: 1, mid: true, scratch: true,
  draw(ctx, ev, k, I) {
    const { cw, ch, S, sc } = I; if (!S) return;
