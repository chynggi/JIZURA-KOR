...
bgReg('auroraRibbons', { name: '오로라', tags: ['emotional', 'calm'], w: 0.9,
...
bgReg('meshBlobs', { name: '메시 그라데이션', tags: ['calm', 'emotional', 'pop'], w: 1, subtle: true,
...
bgReg('duotoneSweep', { name: '2색 스윕', tags: ['calm', 'pop', 'graphic', 'emotional'], w: 0.9, subtle: true,
...
bgReg('horizonGlow', { name: '행성의 테두리', tags: ['emotional', 'calm', 'editorial'], w: 0.8,
...
/* ================= PATTERN ================= */
bgReg('seigaiha', { name: '세이가이하', tags: ['calm', 'editorial', 'graphic'], w: 0.8,
...
bgReg('asanoha', { name: '아사노하', tags: ['calm', 'editorial', 'graphic', 'emotional'], w: 0.8,
...
bgReg('houndstooth', { name: '엇갈린 격자', tags: ['graphic', 'editorial', 'pop'], w: 0.6,
...
bgReg('herringbone', { name: '헤링본', tags: ['editorial', 'calm', 'graphic'], w: 0.6,
...
bgReg('argyle', { name: '아가일', tags: ['pop', 'graphic', 'editorial'], w: 0.6,
...
bgReg('tartan', { name: '타탄', tags: ['pop', 'calm', 'editorial'], w: 0.6,
...
bgReg('chevron', { name: '셰브론', tags: ['pop', 'graphic'], w: 0.6,
...
bgReg('isoCubes', { name: '정육면체', tags: ['graphic', 'pop', 'calm'], w: 0.6,
...
bgReg('hexGrid', { name: '육각 격자', tags: ['graphic', 'glitch', 'calm'], w: 0.8,
...
bgReg('triTess', { name: '삼각 모자이크', tags: ['graphic', 'calm', 'emotional'], w: 0.7,
...
bgReg('moire', { name: '모아레', tags: ['glitch', 'graphic', 'calm'], w: 0.6,
...
bgReg('squareTunnel', { name: '사각 터널', tags: ['glitch', 'graphic', 'pop'], w: 0.6,
...
bgReg('spiralArms', { name: '소용돌이', tags: ['glitch', 'pop', 'graphic'], w: 0.6,
...
bgReg('topoLines', { name: '등고선', tags: ['calm', 'editorial', 'graphic'], w: 0.8,
...
bgReg('ridgePlot', { name: '능선 그래프', tags: ['editorial', 'emotional', 'calm'], w: 0.7,
...
/* ================= SCENE ================= */
bgReg('starfield', { name: '별빛 하늘', tags: ['emotional', 'calm'], w: 0.9,
...
bgReg('nightMoon', { name: '달밤', tags: ['emotional', 'calm', 'editorial'], w: 0.8,
...
bgReg('skyline', { name: '거리 풍경', tags: ['emotional', 'editorial', 'pop'], w: 0.8,
...
bgReg('sunsetSun', { name: '노을', tags: ['emotional', 'calm', 'pop'], w: 0.8,
...
bgReg('oceanWaves', { name: '파도', tags: ['calm', 'emotional', 'editorial'], w: 0.8,
...
bgReg('rainWindow', { name: '비 오는 창', tags: ['emotional', 'calm', 'editorial'], w: 0.8,
...
bgReg('snowLayers', { name: '눈발', tags: ['calm', 'emotional'], w: 0.9,
...
bgReg('fireworks', { name: '불꽃놀이', tags: ['pop', 'emotional'], w: 0.7,
...
bgReg('cloudLayers', { name: '구름', tags: ['calm', 'emotional', 'pop'], w: 0.8,
...
bgReg('mountains', { name: '산맥', tags: ['calm', 'emotional', 'editorial'], w: 0.8,
...
/* ================= TEXTURE / EFFECT ================= */
bgReg('filmStrip', { name: '필름', tags: ['editorial', 'emotional', 'glitch'], w: 0.7,
...
bgReg('vhsBand', { name: 'VHS 노이즈', tags: ['glitch', 'emotional'], w: 0.6,
...
bgReg('tornPaper', { name: '찢어진 종이', tags: ['editorial', 'emotional', 'pop'], w: 0.7,
...
bgReg('godRays', { name: '빛살', tags: ['emotional', 'calm', 'editorial'], w: 0.8,
...
bgReg('vignettePulse', { name: '색빛 주변광', tags: ['emotional', 'calm', 'pop'], w: 0.9, subtle: true,
...
bgReg('kaleidoscope', { name: '만화경', tags: ['pop', 'glitch', 'emotional'], w: 0.6,
...
bgReg('marble', { name: '대리석', tags: ['calm', 'editorial', 'emotional'], w: 0.7,
...
bgReg('paperCut', { name: '종이 오림', tags: ['pop', 'emotional', 'calm'], w: 0.7,
...
reg('cam', 'orbitDrift', { name: '궤도', tags: ['calm', 'emotional', 'graphic'], w: 0.8,
...
reg('cam', 'barrelRoll', { name: '배럴 롤', tags: ['pop', 'glitch', 'graphic'], w: 0.5, strong: true,
...
reg('cam', 'pendulumSway', { name: '흔들 추', tags: ['emotional', 'pop', 'calm'], w: 0.7,
...
reg('cam', 'focusIn', { name: '초점 맞추기', tags: ['emotional', 'calm', 'editorial'], w: 0.9,
...
reg('cam', 'rackFocus', { name: '초점 흔들림', tags: ['emotional', 'calm', 'editorial'], w: 0.6,
...
reg('cam', 'earthquake', { name: '지진', tags: ['glitch', 'pop', 'emotional'], w: 0.5, strong: true,
...
reg('cam', 'floatNoise', { name: '부유', tags: ['calm', 'emotional'], w: 0.9,
...
reg('cam', 'vertigo', { name: '어지러움', tags: ['emotional', 'glitch'], w: 0.6,
...
reg('cam', 'tiltDown', { name: '틸트 다운', tags: ['calm', 'editorial', 'emotional'], w: 0.8,
...
reg('cam', 'spiralIn', { name: '소용돌이 줌', tags: ['pop', 'graphic', 'emotional'], w: 0.6,
...
reg('cam', 'snapPan', { name: '스냅 팬', tags: ['pop', 'glitch', 'graphic'], w: 0.7,
...
reg('cam', 'jelly', { name: '통통', tags: ['pop', 'graphic'], w: 0.7,
