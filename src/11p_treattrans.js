/* JIZURA pack: treattrans — text treatments (neon, chrome, karaoke, reflection, ransom…) + cut-to-cut transitions (컷 간 전환) */
(() => {
'use strict';
const E = J.E;
const PK = 'treattrans';
...
reg('treat', 'neonOutline', { name: '네온관', tags: ['glitch', 'emotional', 'pop'], w: 0.8,
...
reg('treat', 'chrome', { name: '크롬', tags: ['pop', 'graphic'], w: 0.7,
...
reg('treat', 'rainbow', { name: '무지개색', tags: ['pop', 'emotional'], w: 0.7,
...
reg('treat', 'glitchSplit', { name: '색판 어긋남', tags: ['glitch', 'pop'], w: 0.8,
...
reg('treat', 'shadowStack', { name: '다중 그림자', tags: ['pop', 'graphic'], w: 0.8,
...
reg('treat', 'stencilGap', { name: '스텐실 글자', tags: ['graphic', 'editorial', 'glitch'], w: 0.6,
...
reg('treat', 'waterline', { name: '수위', tags: ['emotional', 'pop', 'calm'], w: 0.6,
...
reg('treat', 'sizeWave', { name: '대소 리듬', tags: ['pop', 'graphic', 'editorial'], w: 0.7,
...
reg('treat', 'rotateAlt', { name: '흔들 글자', tags: ['pop', 'emotional'], w: 0.7, safe: true,
...
reg('treat', 'baselineShift', { name: '엇단 배치', tags: ['pop', 'graphic'], w: 0.7, safe: true,
...
reg('treat', 'fauxBold', { name: '극태', tags: ['graphic', 'pop', 'editorial'], w: 0.5, safe: true,
...
reg('treat', 'circled', { name: '동그라미', tags: ['pop', 'graphic', 'editorial'], w: 0.6,
...
reg('treat', 'bracketsQuote', { name: '갈고리 괄호', tags: ['editorial', 'emotional', 'calm'], w: 0.6,
...
reg('treat', 'reflection', { name: '바닥 비침', tags: ['emotional', 'calm', 'editorial'], w: 0.6,
...
/* ---- inline (인라인): a hairline in the background colour runs just inside every stroke, like display type ---- */
reg('treat', 'inline', { name: '인라인', tags: ['editorial', 'pop', 'graphic'], w: 0.6,
...
reg('treat', 'sticker', { name: '스티커 테두리', tags: ['pop', 'graphic'], w: 0.8,
...
reg('treat', 'gradientSweep', { name: '광택 훑기', tags: ['pop', 'emotional'], w: 0.7,
...
reg('treat', 'kerningWide', { name: '자간 넓힘', tags: ['editorial', 'calm', 'emotional'], w: 0.6, safe: true,
...
/* ---- manuscript paper (원고지): glyphs snap into equal square cells of a ruled grid ---- */
reg('treat', 'monoGrid', { name: '원고지풍', tags: ['editorial', 'calm', 'emotional'], w: 0.5,
...
reg('treat', 'outlineOffset', { name: '어긋난 외곽선', tags: ['pop', 'graphic', 'editorial'], w: 0.8,
...
reg('treat', 'toneShadow', { name: '톤 그림자', tags: ['pop', 'graphic', 'editorial'], w: 0.7,
...
reg('treat', 'fadeChars', { name: '여운', tags: ['emotional', 'calm'], w: 0.5, safe: true,
...
reg('treat', 'cutShift', { name: '잘라 밀기', tags: ['graphic', 'glitch', 'pop'], w: 0.7,
...
reg('treat', 'focusPull', { name: '초점 훑기', tags: ['emotional', 'calm', 'editorial'], w: 0.6,
...
reg('treat', 'spotChar', { name: '한 글자 표시', tags: ['pop', 'graphic', 'editorial', 'emotional'], w: 0.7,
...
/* ---- ransom note (오려 붙인 글자): every glyph on its own scrap of paper, tilted and resized ---- */
reg('treat', 'ransom', { name: '오려 붙인 글자', tags: ['pop', 'glitch', 'graphic'], w: 0.6,
...
trReg('wipe', { name: '엣지 와이프', tags: ['graphic', 'editorial', 'pop'], w: 1.2, dur: 0.35,
...
trReg('diagonalWipe', { name: '사선 띠 와이프', tags: ['pop', 'graphic'], w: 1, dur: 0.35,
...
trReg('clockWipe', { name: '시계 와이프', tags: ['graphic', 'pop', 'editorial'], w: 0.7, dur: 0.45,
...
trReg('irisOpen', { name: '아이리스 인', tags: ['emotional', 'pop', 'editorial'], w: 0.8, dur: 0.4,
...
trReg('pushSlide', { name: '푸시', tags: ['graphic', 'pop', 'editorial'], w: 1, dur: 0.35,
...
trReg('cover', { name: '덮기', tags: ['editorial', 'graphic', 'calm'], w: 0.9, dur: 0.35,
...
trReg('uncover', { name: '걷어내기', tags: ['editorial', 'calm', 'emotional'], w: 0.8, dur: 0.35,
...
trReg('zoomThrough', { name: '줌 스루', tags: ['pop', 'emotional', 'glitch'], w: 1, dur: 0.35,
...
trReg('doorsOpen', { name: '양쪽 열림', tags: ['graphic', 'pop', 'emotional'], w: 0.7, dur: 0.4,
...
trReg('blinds', { name: '블라인드 전환', tags: ['graphic', 'editorial', 'calm'], w: 0.7, dur: 0.4,
...
trReg('checker', { name: '체크 전환', tags: ['pop', 'graphic'], w: 0.6, dur: 0.45,
...
trReg('blockDissolve', { name: '블록 붕괴', tags: ['glitch', 'graphic'], w: 0.8, dur: 0.4,
...
trReg('whipPan', { name: '휩 팬', tags: ['pop', 'emotional', 'glitch'], w: 1, dur: 0.3,
...
trReg('spinOut', { name: '회전 아웃', tags: ['pop', 'glitch'], w: 0.6, dur: 0.45,
...
trReg('inkBlob', { name: '잉크 얼룩', tags: ['emotional', 'calm', 'pop'], w: 0.7, dur: 0.5,
...
trReg('shatterTiles', { name: '타일 붕괴', tags: ['glitch', 'pop', 'emotional'], w: 0.6, dur: 0.5,
...
trReg('sliceShift', { name: '띠 밀기', tags: ['glitch', 'graphic', 'pop'], w: 0.8, dur: 0.35,
...
trReg('cubeTurn', { name: '큐브', tags: ['graphic', 'pop'], w: 0.6, dur: 0.45,
...
trReg('flashCross', { name: '플래시 전환', tags: ['emotional', 'pop', 'calm'], w: 0.9, dur: 0.3,
...
trReg('pixelate', { name: '모자이크 전환', tags: ['glitch', 'pop'], w: 0.6, dur: 0.4,
