...
const DEFS = {
  ...
  springIn: {
    ...
    name: '탄력', tags: ['pop'], w: 0.9, ae: 'drop', minDur: 0.5,
  ...
  pendulum: {
    ...
    name: '흔들 추', tags: ['pop', 'emotional', 'calm'], w: 0.9, ae: 'spin', minDur: 0.5,
  ...
  rollIn: {
    ...
    name: '구르기', tags: ['pop', 'graphic'], w: 0.9, ae: 'spin',
    apply(env, it, p) {
  ...
  slingshot: {
    ...
    name: '튕기기', tags: ['pop', 'graphic'], w: 0.7, ae: 'stretch', minDur: 0.55,
  ...
  rockSettle: {
    ...
    name: '흔들 착지', tags: ['pop'], w: 0.8, ae: 'drop', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.22, 0.9),
    apply(env, it, p) {
  ...
  bounceBall: {
    ...
    name: '바운스 볼', tags: ['pop', 'emotional'], w: 0.8, ae: 'pop', minDur: 0.8, maxChars: 20,
  ...
  snapRail: {
    ...
    name: '스냅 정렬', tags: ['graphic', 'pop', 'editorial'], w: 0.9, ae: 'assemble', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  fanOpen: {
    ...
    name: '부채 펼침', tags: ['emotional', 'graphic', 'calm'], w: 0.9, ae: 'spin',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  cylinder: {
    ...
    name: '원통 회전', tags: ['graphic', 'pop', 'editorial'], w: 0.9, ae: 'spin',
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  shuffle: {
    ...
    name: '셔플', tags: ['pop', 'glitch', 'graphic'], w: 0.9, ae: 'scramble', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, size = it.size, seed = it.seed | 0;
  ...
  stopMotion: {
    ...
    name: '프레임 스텝', tags: ['pop', 'emotional'], w: 0.8, ae: 'pop', minDur: 0.5,
  ...
  ripple: {
    ...
    name: '잔물결', tags: ['emotional', 'calm', 'graphic'], w: 1, ae: 'pop',
    apply(env, it, p) {
  ...
  zipper: {
    ...
    name: '지퍼', tags: ['graphic', 'pop'], w: 0.8, ae: 'slice',
  ...
  zoomAlt: {
    ...
    name: '번갈아 줌', tags: ['pop', 'graphic', 'glitch'], w: 0.9, ae: 'zoom',
    apply(env, it, p) {
  ...
  tiltUp: {
    ...
    name: '일어서기', tags: ['graphic', 'editorial', 'pop'], w: 0.9, ae: 'stretch',
    apply(env, it, p) {
  ...
  stickerPeel: {
    ...
    name: '스티커 붙이기', tags: ['pop', 'graphic', 'editorial'], w: 0.9, ae: 'wipe', minDur: 0.5,
  ...
  crumple: {
    ...
    name: '구겨짐 복귀', tags: ['pop', 'graphic', 'emotional'], w: 0.7, ae: 'assemble', pieces: true, minDur: 0.5,
  ...
  noteUnfold: {
    ...
    name: '편지 펼치기', tags: ['emotional', 'calm', 'graphic'], w: 0.8, ae: 'pop', minDur: 0.6,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  tornJoin: {
    ...
    name: '찢어 맞춤', tags: ['graphic', 'emotional', 'pop'], w: 0.8, ae: 'slice',
    inDur: dur => clamp(dur * 0.42, 0.18, 0.75),
    apply(env, it, p) {
  ...
  splitFlap: {
    // split-flap display (플립): each glyph flaps through a few random characters before landing on its own
    name: '플립 교체', tags: ['glitch', 'editorial', 'graphic'], w: 0.9, ae: 'scramble', minDur: 0.75,
  ...
  overexpose: {
    ...
    name: '과다 노출', tags: ['emotional', 'pop', 'glitch'], w: 1, ae: 'blur',
    inDur: dur => clamp(dur * 0.42, 0.18, 0.75),
    apply(env, it, p) {
  ...
  glint: {
    ...
    name: '글린트', tags: ['editorial', 'emotional', 'graphic'], w: 1, ae: 'wipe',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  loupe: {
    ...
    name: '돋보기', tags: ['editorial', 'pop', 'calm'], w: 0.8, ae: 'zoom', minDur: 0.6,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  filmFeed: {
    ...
    name: '필름 감기', tags: ['emotional', 'glitch', 'editorial'], w: 0.8, ae: 'flicker', minDur: 0.55,
  ...
  backlight: {
    ...
    name: '역광', tags: ['emotional', 'calm'], w: 0.9, ae: 'blur', minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
  ...
  lightLeak: {
    ...
    name: '빛 누수', tags: ['emotional', 'calm', 'pop'], w: 0.9, ae: 'blur',
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      const vert = !!it.vertical, isx = it.sx || 1, isy = it.sy || 1, size = it.size, b = box(it);
  ...
  heatHaze: {
    ...
    name: '열기 아지랑이', tags: ['emotional', 'calm', 'glitch'], w: 0.9, ae: 'slice',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  crtOn: {
    ...
    name: 'CRT 전원', tags: ['glitch', 'pop', 'graphic'], w: 0.9, ae: 'stretch',
    apply(env, it, p) {
  ...
  interlace: {
    ...
    name: '인터레이스', tags: ['glitch', 'graphic', 'editorial'], w: 0.9, ae: 'slice',
    apply(env, it, p) {
  ...
  loadingBar: {
    ...
    name: '로딩', tags: ['graphic', 'editorial', 'glitch'], w: 0.8, ae: 'wipe', minDur: 0.7,
  ...
  dither: {
    ...
    name: '디더', tags: ['glitch', 'graphic'], w: 0.9, ae: 'flicker',
    apply(env, it, p) {
  ...
  odometer: {
    ...
    name: '드럼 회전', tags: ['glitch', 'editorial', 'pop'], w: 0.9, ae: 'scramble', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  matrixRain: {
    ...
    name: '데이터 낙하', tags: ['glitch', 'graphic'], w: 0.8, ae: 'scramble', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  hatchFill: {
    ...
    name: '해칭→채움', tags: ['graphic', 'editorial'], w: 0.9, ae: 'blur',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  brushReveal: {
    ...
    name: '붓 쓸기', tags: ['emotional', 'editorial', 'calm'], w: 1, ae: 'wipe',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.85),
    apply(env, it, p) {
  ...
  inkDrop: {
    ...
    name: '잉크 방울', tags: ['calm', 'emotional', 'graphic'], w: 1, ae: 'blur',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.85),
    apply(env, it, p) {
  ...
  quarters: {
    ...
    name: '사방 집결', tags: ['graphic', 'pop'], w: 0.9, ae: 'assemble',
    apply(env, it, p) {
  ...
  invertBox: {
    ...
    name: '반전 통과', tags: ['graphic', 'editorial', 'pop'], w: 0.9, ae: 'wipe',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  printRegister: {
    ...
    name: '판 어긋남', tags: ['graphic', 'pop', 'editorial'], w: 0.9, ae: 'slice',
    inDur: dur => clamp(dur * 0.45, 0.2, 0.8),
    apply(env, it, p) {
  ...
  echoCount: {
    ...
    name: '카운트 인', tags: ['pop', 'graphic', 'glitch'], w: 0.8, ae: 'zoom', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  liquidFill: {
    ...
    name: '수위 상승', tags: ['emotional', 'calm', 'pop'], w: 0.9, ae: 'wipe', minDur: 0.5,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  windBlown: {
    ...
    name: '바람을 타고', tags: ['emotional', 'calm'], w: 0.8, ae: 'assemble', pieces: true, minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
      if (p >= 1) return;
  ...
  strokeOrder: {
    ...
    name: '한 획씩', tags: ['calm', 'emotional', 'editorial'], w: 0.9, ae: 'assemble', pieces: true, minDur: 0.6,
  ...
  clockWipe: {
    ...
    name: '시계 방향', tags: ['graphic', 'pop', 'editorial'], w: 0.9, ae: 'wipe',
    apply(env, it, p) {
      const isx = it.sx || 1, isy = it.sy || 1, size = it.size, seed = it.seed | 0;
      const qf = (i, n) => stg(p, ordLR(i, n), 0.5);
  ...
  shadowFirst: {
    ...
    name: '그림자 찍기', tags: ['pop', 'graphic', 'emotional'], w: 0.9, ae: 'drop', minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
  ...
  bubbles: {
    ...
    name: '거품', tags: ['pop', 'emotional', 'calm'], w: 0.8, ae: 'pop', minDur: 0.55,
    inDur: dur => clamp(dur * 0.5, 0.25, 0.9),
    apply(env, it, p) {
  ...
  tokoroten: {
    // 토코로텐: the line is pushed out through a slit, glyphs squeezed thin at the slit and relaxing as they emerge
    name: '토코로텐', tags: ['pop', 'graphic'], w: 0.7, ae: 'stretch', minDur: 0.5,
    inDur: dur => clamp(dur * 0.48, 0.22, 0.85),
    apply(env, it, p) {
