/* ============================================================
   ...
   1) 추가 연출 (extra): everything added after the first public
      version (356 parts, 12 styles). Random picks (planner /
      자동 / 셔플) use the first version's set unless
      project.extra === true.
   2) 일본풍 (wa): entries built around a traditional Japanese object,
...
// mark the part sets, then 추가 연출 (set entries are not 추가 연출: they have their own switch)
...
/* may random picks use this entry? (g: a group key, 'style' or 'font') — 추가 연출 first, then 일본풍 */
