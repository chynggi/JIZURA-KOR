...
const DEFS = {
  ...
  /* ---------- glyph masks ---------- */
  riseMask: {
    name: '아래에서 등장', tags: ['editorial', 'graphic', 'calm', 'emotional'], w: 1.4,
    apply(env, it, p) {
  ...
  dropMask: {
    name: '위에서 등장', tags: ['editorial', 'graphic', 'pop'], w: 1.2,
    apply(env, it, p) {
      const isx = it.sx || 1, isy = it.sy || 1;
      glyphs(it, (i, g, n) => {
        const q = stg(p, ordLR(i, n), 0.45);
  ...
  /* ---------- slides ---------- */
  slideL: {
    name: '왼쪽 슬라이드', tags: ['editorial', 'calm', 'pop'], w: 1,
    apply(env, it, p) {
      const size = it.size;
      glyphs(it, (i, g, n) => {
  ...
  slideR: {
    ...
    name: '오른쪽 슬라이드', tags: ['editorial', 'graphic', 'pop'], w: 1,
    apply(env, it, p) {
      const isx = it.sx || 1, isy = it.sy || 1;
      glyphs(it, (i, g, n) => {
        const q = stg(p, ordLR(i, n), 0.45);
  ...
  slideWhole: {
    name: '전체 슬라이드', tags: ['pop', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  flipX: {
    ...
    name: '세로 뒤집기', tags: ['pop', 'graphic', 'editorial'], w: 1,
    apply(env, it, p) {
  ...
  flipY: {
    ...
    name: '가로 뒤집기', tags: ['pop', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  domino: {
    name: '도미노', tags: ['pop'], w: 0.7, minDur: 0.5,
  ...
  fold: {
    ...
    name: '펼쳐 열기', tags: ['graphic', 'editorial'], w: 0.9,
    apply(env, it, p) {
  ...
  unroll: {
    name: '감아 열기', tags: ['calm', 'editorial', 'emotional'], w: 0.9,
    apply(env, it, p) {
  ...
  /* ---------- line work ---------- */
  strokeDraw: {
    name: '선화 채색', tags: ['calm', 'emotional', 'editorial'], w: 1, minDur: 0.8,
  ...
  outlineFill: {
    name: '외곽선→채움', tags: ['graphic', 'pop', 'editorial'], w: 1, minDur: 0.7,
  ...
  splitJoin: {
    ...
    name: '상하 합체', tags: ['graphic', 'editorial'], w: 0.9,
    apply(env, it, p) {
  ...
  /* ---------- graphic masks ---------- */
  vSlice: {
    name: '세로 슬라이스', tags: ['graphic', 'glitch'], w: 1,
    apply(env, it, p) {
  ...
  shutter: {
    name: '셔터', tags: ['graphic', 'editorial'], w: 1,
    apply(env, it, p) {
  ...
  iris: {
    name: '아이리스', tags: ['pop', 'emotional', 'graphic'], w: 0.8,
    apply(env, it, p) {
      const e = oQuart(p);
  ...
  diagWipe: {
    ...
    name: '사선 와이프', tags: ['graphic', 'editorial', 'pop'], w: 1,
    apply(env, it, p) {
  ...
  blinds: {
    name: '블라인드', tags: ['graphic', 'editorial'], w: 0.8,
    apply(env, it, p) {
      const vert = !!it.vertical, size = it.size;
      clipLocal(it, (ctx, b) => {
        const m = size * 0.2;
  ...
  checker: {
    name: '체크무늬', tags: ['graphic', 'glitch', 'pop'], w: 0.7,
    apply(env, it, p) {
  ...
  randomOrder: {
    name: '랜덤 순서', tags: ['pop', 'glitch'], w: 1,
    apply(env, it, p) {
  ...
  /* ---------- squash & stretch ---------- */
  bounceBig: {
    name: '큰 도약', tags: ['pop'], w: 0.7, minDur: 0.7,
    inDur: dur => clamp(dur * 0.5, 0.2, 0.95),
    apply(env, it, p) {
  ...
  squashDrop: {
    name: '눌려 착지', tags: ['pop'], w: 0.8, minDur: 0.5,
    inDur: dur => clamp(dur * 0.42, 0.15, 0.75),
    apply(env, it, p) {
      const isy = it.sy || 1;
      glyphs(it, (i, g, n) => {
  ...
  rubber: {
    name: '고무 신축', tags: ['pop'], w: 0.8, minDur: 0.45,
    inDur: dur => clamp(dur * 0.42, 0.15, 0.75),
    apply(env, it, p) {
      glyphs(it, (i, g, n) => {
        const q = stg(p, ordLR(i, n), 0.4);
  ...
  echoIn: {
    ...
    name: '잔상 집속', tags: ['graphic', 'emotional', 'pop'], w: 1,
    apply(env, it, p) {
  ...
  skewIn: {
    name: '기울임 변형', tags: ['editorial', 'graphic'], w: 0.9,
    apply(env, it, p) {
  ...
  trackIn: {
    name: '자간 수렴', tags: ['calm', 'editorial', 'emotional'], w: 1.2,
    apply(env, it, p) {
      const e = oQuint(p);
  ...
  trackOut: {
    name: '자간 확장', tags: ['calm', 'editorial', 'pop'], w: 1,
    apply(env, it, p) {
      const e = oQuint(p);
  ...
  /* ---------- soft ---------- */
  blurStagger: {
    name: '흐림 단차', tags: ['calm', 'emotional'], w: 1.2,
    apply(env, it, p) {
  ...
  fadeStagger: {
    name: '글자별 페이드', tags: ['calm', 'emotional'], w: 1.2,
  ...
  waveIn: {
    name: '물결 치기', tags: ['pop', 'emotional'], w: 0.9, minDur: 0.5,
    inDur: dur => clamp(dur * 0.45, 0.15, 0.85),
    apply(env, it, p) {
  ...
  spiralIn: {
    name: '나선 집합', tags: ['pop', 'emotional'], w: 0.7, minDur: 0.5,
    inDur: dur => clamp(dur * 0.42, 0.15, 0.75),
    apply(env, it, p) {
  ...
  zoomOut: {
    name: '거대→실제 크기', tags: ['pop', 'graphic', 'glitch'], w: 1,
    apply(env, it, p) {
      const e = E.outExpo(p);
  ...
  /* ---------- reveal devices ---------- */
  resolve: {
    name: '해독', tags: ['glitch', 'editorial'], w: 0.9, minDur: 0.6,
  ...
  magnet: {
    name: '자석', tags: ['pop', 'graphic'], w: 0.8, minDur: 0.6,
  ...
  inkBleed: {
    name: '번짐', tags: ['calm', 'emotional'], w: 1,
  ...
  neonOn: {
    name: '네온 점등', tags: ['glitch', 'emotional', 'pop'], w: 0.8, minDur: 0.6,
    inDur: dur => clamp(dur * 0.5, 0.2, 0.9),
    apply(env, it, p) {
  ...
  cursorSweep: {
    name: '커서 훑기', tags: ['editorial', 'graphic'], w: 1,
  ...
  stamp: {
    name: '스탬프', tags: ['pop', 'graphic'], w: 0.9,
    inDur: dur => clamp(dur * 0.4, 0.14, 0.7),
    apply(env, it, p) {
