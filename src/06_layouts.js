...
J.LAYOUTS = {
  ...
  /* ------------------------------------------------ special: title card */
  title: {
    name: '제목', special: true, fits: () => false,
  ...
  /* ------------------------------------------------ special: interlude */
  interlude: {
    name: '간주', special: true, fits: () => false,
