...
for (const style of D.styleOrder) {
  for (const [seed, extra, wa] of [[1, false, true], [7, true, true], [42, true, false]]) {
    const { env, JZ } = load();
    const o = { lyrics, title: '테스트', artist: 'me', style, seed, fx: { motion: 0.8, glitch: 0.7, chroma: 0.7, decor: 0.8, density: 0.6, texture: 0.6, bgSwitch: 0.5, onTwos: true, flash: true, hud: true, interCount: 'auto', interCredit: true },
