...
function jzMakePlan(o) {
    ...
    jzSetLang(plan.lang);
    var hist = [], bgHist = [], fxHist = [], schemeIdx = 0, nS = st.schemes.length, creditDone = false;
